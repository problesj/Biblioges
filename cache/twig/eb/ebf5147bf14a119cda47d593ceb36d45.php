    ...
    <div class=\"d-flex\">
        ...
        <div class=\"sidebar\" id=\"sidebar\">
            <div class=\"p-3\">
                ...
                <ul class=\"nav flex-column\">
                    ...
                    <li class=\"menu-group\">REPORTES</li>
                    <li class=\"nav-item\">
                        <a class=\"nav-link {% if current_page == 'cobertura' %}active{% endif %}\" href=\"{{ app_url }}cobertura\">
                            <i class=\"fas fa-chart-pie\"></i> Cobertura
                        </a>
                    </li>
                    <li class=\"nav-item\">
                        <a class=\"nav-link {% if current_page == 'listado-bibliografias' %}active{% endif %}\" href=\"{{ app_url }}listado-bibliografias\">
                            <i class=\"fas fa-file-alt\"></i> Listado de Bibliografías
                        </a>
                    </li>
                    <li class=\"nav-item\">
                        <a class=\"nav-link {% if current_page == 'reportes-personalizados' %}active{% endif %}\" href=\"{{ app_url }}reportes-personalizados\">
                            <i class=\"fas fa-cogs\"></i> Reportes Personalizados
                        </a>
                    </li>
        ...
        <div class=\"content\" id=\"content\">
            ...
            <main class=\"container-fluid py-4\">
                ...
                {% if session.success is not empty %}
