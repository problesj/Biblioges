...
/* mallas/fusion_asignaturas.twig */
class __TwigTemplate_9e4dda7803d82387c6bc669e7f943284 extends Template
{
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("base.twig", "mallas/fusion_asignaturas.twig", 1);
...
";
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 394
        yield "<div class=\"fusion-container\">
    <div class=\"container\">
        <!-- Header -->
        <div class=\"fusion-card\">
            <div class=\"fusion-header\">
                ...
                <p>";
        // line 400
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["carrera"] ?? null), "nombre", [], "any", false, false, false, 400), "html", null, true);
        yield " - ";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::join(CoreExtension::getAttribute($this->env, $this->source, ($context["carrera"] ?? null), "codigos_carrera", [], "any", false, false, false, 400), ", "), "html", null, true);
        yield "</p>
            </div>
        </div>
        ...
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, ($context["carrera"] ?? null), "asignaturas", [], "any", false, false, false, 432));
        foreach ($context['_seq'] as $context["_key"] => $context["asignatura"]) {
            // line 433
            yield "                                <div class=\"asignatura-card\" data-id=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["asignatura"], "id", [], "any", false, false, false, 433), "html", null, true);
            yield "\" data-step=\"principal\">
                                    <div class=\"asignatura-info\">
                                        <h5>";
            // line 435
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["asignatura"], "nombre", [], "any", false, false, false, 435), "html", null, true);
            yield "</h5>
                                        <p><strong>Tipo:</strong> ";
            // line 436
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["asignatura"], "tipo", [], "any", false, false, false, 436), "html", null, true);
            yield "</p>
                                        <p><strong>Semestre:</strong> ";
            // line 437
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["asignatura"], "semestre", [], "any", false, false, false, 437), "html", null, true);
            yield "</p>
                                        <p><strong>Estado:</strong> 
                                            <span class=\"badge badge-";
            // line 439
            yield ((CoreExtension::getAttribute($this->env, $this->source, $context["asignatura"], "estado", [], "any", false, false, false, 439)) ? ("success") : ("danger"));
            yield "\">
                                                ";
            // line 440
            yield ((CoreExtension::getAttribute($this->env, $this->source, $context["asignatura"], "estado", [], "any", false, false, false, 440)) ? ("Activa") : ("Inactiva"));
            yield "
                                            </span>
                                        </p>
                                        ";
            // line 443
            if (CoreExtension::getAttribute($this->env, $this->source, $context["asignatura"], "codigos", [], "any", false, false, false, 443)) {
                // line 444
                yield "                                        <p><strong>Códigos:</strong></p>
                                        ";
                // line 445
                $context['_parent'] = $context;
                $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, $context["asignatura"], "codigos", [], "any", false, false, false, 445));
                foreach ($context['_seq'] as $context["_key"] => $context["codigo"]) {
                    // line 446
                    yield "                                        <span class=\"codigos-badge\">";
        ...
        // line 460
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, ($context["carrera"] ?? null), "asignaturas", [], "any", false, false, false, 460));
        foreach ($context['_seq'] as $context["_key"] => $context["asignatura"]) {
            // line 461
            yield "                                <div class=\"asignatura-card fusionar\" data-id=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["asignatura"], "id", [], "any", false, false, false, 461), "html", null, true);
            yield "\" data-step=\"fusionar\">
                                    <div class=\"asignatura-info\">
                                        <h5>";
            // line 463
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["asignatura"], "nombre", [], "any", false, false, false, 463), "html", null, true);
            yield "</h5>
                                        <p><strong>Tipo:</strong> ";
            // line 464
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["asignatura"], "tipo", [], "any", false, false, false, 464), "html", null, true);
            yield "</p>
                                        <p><strong>Semestre:</strong> ";
            // line 465
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["asignatura"], "semestre", [], "any", false, false, false, 465), "html", null, true);
            yield "</p>
                                        <p><strong>Estado:</strong> 
                                            <span class=\"badge badge-";
            // line 467
            yield ((CoreExtension::getAttribute($this->env, $this->source, $context["asignatura"], "estado", [], "any", false, false, false, 467)) ? ("success") : ("danger"));
            yield "\">
                                                ";
            // line 468
            yield ((CoreExtension::getAttribute($this->env, $this->source, $context["asignatura"], "estado", [], "any", false, false, false, 468)) ? ("Activa") : ("Inactiva"));
            yield "
                                            </span>
                                        </p>
                                        ";
            // line 471
            if (CoreExtension::getAttribute($this->env, $this->source, $context["asignatura"], "codigos", [], "any", false, false, false, 471)) {
                // line 472
                yield "                                        <p><strong>Códigos:</strong></p>
                                        ";
                // line 473
                $context['_parent'] = $context;
                $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, $context["asignatura"], "codigos", [], "any", false, false, false, 473));
                foreach ($context['_seq'] as $context["_key"] => $context["codigo"]) {
                    // line 474
                    yield "                                        <span class=\"codigos-badge\">";
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($context["codigo"], "html", null, true);
        ...
        yield "mallas/";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["carrera"] ?? null), "id", [], "any", false, false, false, 610), "html", null, true);
        yield "\" class=\"btn btn-fusion\">
                        <i class=\"fas fa-eye\"></i> Ver Malla
                    </a>
                    <a href=\"";
        // line 613
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["app_url"] ?? null), "html", null, true);
        yield "mallas\" class=\"btn btn-secondary-custom ms-3\">
...
function cargarBibliografias() {
    ...
    fetch('";
        // line 673
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["app_url"] ?? null), "html", null, true);
        yield "api/mallas/bibliografias-fusion', {
        method: 'POST',
        headers: {
        ...
        body: JSON.stringify({
            ...
            carrera_id: ";
        // line 681
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["carrera"] ?? null), "id", [], "any", false, false, false, 681), "html", null, true);
        yield "
        })
    })
...
async function procesarFusion() {
    ...
    fetch('";
        // line 1149
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["app_url"] ?? null), "html", null, true);
        yield "api/mallas/procesar-fusion', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
        body: JSON.stringify({
            ...
            carrera_id: ";
        // line 1158
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["carrera"] ?? null), "id", [], "any", false, false, false, 1158), "html", null, true);
        yield ",
...
";
    ...
    {
        return "mallas/fusion_asignaturas.twig";
    }
    ...
    {
        return array (  1355 => 1158,  1343 => 1149,  872 => 681,  861 => 673,  810 => 624,  803 => 623,  789 => 613,  781 => 610,  649 => 480,  641 => 477,  638 => 476,  629 => 474,  625 => 473,  622 => 472,  620 => 471,  614 => 468,  610 => 467,  605 => 465,  601 => 464,  597 => 463,  591 => 461,  587 => 460,  577 => 452,  569 => 449,  566 => 448,  557 => 446,  553 => 445,  550 => 444,  548 => 443,  542 => 440,  538 => 439,  533 => 437,  529 => 436,  525 => 435,  519 => 433,  515 => 432,  478 => 400,  470 => 394,  463 => 393,  73 => 6,  66 => 5,  54 => 3,  43 => 1,);
    }
...
{% endblock %}
", "mallas/fusion_asignaturas.twig", "/var/www/html/biblioges/templates/mallas/fusion_asignaturas.twig");
    }
}
